...
```php
...
use srag\GeneratePluginInfosHelper\H5PPageComponent\x\GeneratePluginPhpAndXml; 
...
...
```php
...
use srag\GeneratePluginInfosHelper\H5PPageComponent\x\GeneratePluginReadme; 
...
